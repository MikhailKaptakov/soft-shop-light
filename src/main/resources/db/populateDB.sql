...
VALUES (1, 'prod1','vendor1','country1','33 minutes','description',1000,5,true,true),
       (2, 'prod2', 'vendor2', 'country2', '33 years' , 'undescription', 5, 550, 'true', 'false'),
       (3, 'prod3', 'vendor3', 'country3', '5 seconds' , 'useless program', 100000, 5, 'false', 'true'),
       (4, 'prod4', 'vendor3', 'country3', '5 seconds' , 'useless program', 1000, 5, 'false', 'false'),
       (5, 'prod5', 'vendor3', 'country3', '5 seconds' , 'useless program', 10000, 5, 'false', 'true');
